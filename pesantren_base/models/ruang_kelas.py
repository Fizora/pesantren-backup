...
class ruang_kelas(models.Model):
    ...
    def _onchange_detect_duplikat_kelas_aktif(self):
        ...
        if self.name and self.tahunajaran_id and self.aktif_tidak == 'aktif':
            ...
            # elif duplikat_konfirm and self.status == 'draft':
            #     return {
            #         'warning': {
            #             'title': "Peringatan: Kelas Sudah Ada",
            #             'message': "Ada kelas lain yang aktif dan terkonfirmasi dengan nama dan tahun ajaran yang sama. "
            #                      "Kelas ini akan tetap dalam status draft sampai kelas lain diubah statusnya.",
            #         }
            #     }
            # elif duplikat_draft:
            #     return {
            #         'warning': {
            #             'title': "Info: Duplikat Kelas Draft",
            #             'message': "Ada kelas lain dengan status draft yang memiliki nama dan tahun ajaran yang sama. "
            #                      "Duplikat diperbolehkan selama masih dalam status draft.",
            #         }
            #     }
