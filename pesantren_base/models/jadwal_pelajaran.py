...
class JadwalPelajaran(models.Model):
    ...
    jenjang             = fields.Selection(selection=[('paud','PAUD'),('tk','TK/RA'),('sd', 'SD/MI'), ('smp', 'SMP/MTS'), ('sma', 'SMA/MA'), ('nonformal', 'Nonformal')], string='Jenjang', related='kelas_id.jenjang', readonly=True)
...
class JadwalPelajaranLine(models.Model):
    ...
    jenjang             = fields.Selection(selection=[('paud','PAUD'),('tk','TK/RA'),('sd', 'SD/MI'), ('smp', 'SMP/MTS'), ('sma', 'SMA/MA'), ('nonformal', 'Nonformal')], string='Jenjang', related='jadwalpelajaran_id.jenjang', readonly=True)
