...
class komponen_biaya(models.Model):
    ...
    kredit              = fields.Boolean(string="Kredit", default=False, help='Tagihan bisa dibayar dengan cicilan')
    autodebet           = fields.Boolean(string="Autodebet", default=False, help='Tagihan otomatis terpotong saat topup') 
