...
export class SekolahKpiCard extends Component {
  ...
  async updateKpiData() {
    ...
    try {
      ...
      let siswaData = await this.orm.call("cdn.siswa", "search_read", [
        domain,
        [
          "id",
          "complete_name",
      ...
      let ortuData = await this.orm.call("cdn.orangtua", "search_read", [
        domain,
        ["id", "complete_name"],
      ]);

      const guruData = await this.orm.call("hr.employee", "search_read", [
        [["jns_pegawai", "=", "guru"]],
        ["id", "jns_pegawai"],
      ]);
      ...
      let siswa = siswaData.length;
      let ortu = ortuData.length;
      let guru = guruData.length;
