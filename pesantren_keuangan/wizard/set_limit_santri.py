...
class SetLimitSantri(models.TransientModel):
    ...
    santri_id        = fields.Many2one('cdn.siswa', string="Santri", required=True, default=lambda self: self._get_partner_id(), ondelete='cascade')
    ...
    kartu            = fields.Char(string="Kartu Santri", related='santri_id.barcode_santri')
    ...
    def action_set_limit(self):
        ...
        elif self.limit == 'minggu':
            reset_date = now + relativedelta(weeks=1)
        elif self.limit == 'bulan':
