...
class inheritRecruitment(models.Model):
    ...
    #     # Validate stages
    #     valid_stages = [3, 4, 5]  # Stages where email sending is allowed
    #     records_to_process = self.filtered(lambda r: r.active and r.stage_id.id in valid_stages)
    ...
    #             'params': {
    #                 'title': 'Peringatan',
    #                 'message': 'Tidak ada data yang dapat diproses untuk pengiriman email.',
    #                 'type': 'warning',
    #                 'sticky': False,
    #             }
    #         }
    ...
    #     thn_sekarang = fields.Date.today().year

    #     success_count = 0
    #     for record in records_to_process:
    #         try:
    #             # Calendar event logic
    #             tgl_wawancara_m = tgl_wawancara_a = False
                
    #             # Determine interview dates based on stage
    ...
    #                 if existing_event:
    #                     if record.candidate_id.partner_id.id not in existing_event.partner_ids.ids:
    #                         existing_event.write({
    #                             'partner_ids': [(4, record.candidate_id.partner_id.id)]
    #                         })
    #                 else:
    ...
    #                         tanggal = pytz.utc.localize(tanggal)
    #                     tanggal_local = tanggal.astimezone(local_tz)
    #                     return tanggal_local.strftime('%d-%b-%Y pukul %H:%M')
    #                 return "Tanggal tidak diisi"

    #             formatted_start = format_tanggal(tgl_wawancara_m)
    #             formatted_end = format_tanggal(tgl_wawancara_a)
    ...
    #                 email_subject = "Berlaku"

    #             # Determine gender greeting
    #             gender_greeting = "Yth. Bpk " if record.gender == 'L' else "Yth. Ibu " if record.gender == 'P' else "Yth "
    ...
    #                                     {gender_greeting}<strong>{record.candidate_id.partner_name}</strong>,<br>
    #                                     {email_body_intro}
    #                                 </p>
    #                                 <div style="background-color: #f9f9f9; padding: 15px; border-radius: 5px; margin: 20px 0;">
    #                                     <h3>Tanggal Wawancara</h3>
    #                                     <table style="width: 100%; border-collapse: collapse;">
    #                                         <tr>
    #                                             <td style="padding: 8px; font-weight: bold; color: #333333;">{email_subject} Mulai :</td>
    #                                             <td style="padding: 8px; color: #555555;">{formatted_start}</td>
    #                                         </tr>
    #                                         <tr>
    #                                             <td style="padding: 8px; font-weight: bold; color: #333333;">{email_subject} Berakhir :</td>
    #                                             <td style="padding: 8px; color: #555555;">{formatted_end}</td>
    #                                         </tr>
    #                                     </table>
    ...
    #                                     <table style="width: 100%; border-collapse: collapse;">
    #                                         <tr>
    #                                             <td style="padding: 8px; font-weight: bold; color: #333333;">Jabatan :</td>
    #                                             <td style="padding: 8px; color: #555555;">{record.job_id.name if record.job_id else 'Belum diisi'}</td>
    #                                         </tr>
    #                                     </table>

    #                                     <h3>Lembaga Pendidikan Yang Dipilih</h3>
    #                                     <table style="width: 100%; border-collapse: collapse;">
    #                                         <tr>
    #                                             <td style="padding: 8px; font-weight: bold; color: #333333;">Lembaga :</td>
    #                                             <td style="padding: 8px; color: #555555;">{
    #                                                 dict(record._fields['lembaga'].selection).get(record.lembaga, 'Belum diisi')
    #                                             }</td>
    #                                         </tr>
    #                                     </table>
    #                                 </div>
    ...
    #             _logger.error(f"Error sending email to {record.email_from}: {str(e)}")
    ...
    #         'params': {
    #             'title': 'Sukses',
    #             'message': f'Berhasil mengirim {success_count} email dari {len(records_to_process)} data yang dipilih.',
    #             'type': 'success',
    #             'sticky': False,
    #         }
    #     }
    ...
    def kirim_email_applicant(self):
        for record in self:
            ...
            #                     </p>
            #                     <div style="background-color: #f9f9f9; padding: 15px; border-radius: 5px; margin: 20px 0;">
            #                         <h3>Tanggal {email_subject}</h3>
            #                         <table style="width: 100%; border-collapse: collapse;">
            #                             <tr>
            #                                 <td style="padding: 8px; font-weight: bold; color: #333333;">{email_subject} Mulai :</td>
            #                                 <td style="padding: 8px; color: #555555;">{tgl_wawancara_m}</td>
            #                             </tr>
            #                             <tr>
            #                                 <td style="padding: 8px; font-weight: bold; color: #333333;">{email_subject} Berakhir :</td>
            #                                 <td style="padding: 8px; color: #555555;">{tgl_wawancara_a}</td>
            #                             </tr>
            #                         </table>
